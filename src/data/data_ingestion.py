...
def main():
    try:
        ...
        df = load_data(data_url='https://raw.githubusercontent.com/shubhcode1/MLOPS---Capstone-Project/main/notebooks/data.csv')
        # s3 = s3_connection.s3_operations("capstone-proj-7499", "AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY")
